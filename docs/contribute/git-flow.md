...
<!-- Title: Contributing GitFlow DockerActiveMQ -->
...
```bash
git remote add upstream  https://github.com/hadenlabs/docker-activemq.git
```

Now your **upstream** points to **hadenlabs/docker-activemq**.
...
git fetch upstream # assuming upstream is hadenlabs/docker-activemq
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/docker-activemq/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
